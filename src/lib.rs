...
pub type AsciiFn = fn(&[f64]) -> Option<f64>;
...
/// ```
/// # use asciilines::*;
/// assert_eq!(Some(0.0), funct1(&[]));
/// ```
/// ```
/// # use asciilines::*;
/// assert_eq!(Some(0.0), funct1(&[-1.0, 1.0]));
/// ```
pub fn funct1(nums: &[f64]) -> Option<f64> {
...
/// ```
pub fn funct2(nums: &[f64]) -> Option<f64> {
    let mut sigma = 0.0;
...
/// ```
pub fn funct3(nums: &[f64]) -> Option<f64> {
